...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.LocationControlService, App1", LocationControlService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == LocationControlService.class)
			mono.android.TypeManager.Activate ("App1.LocationControlService, App1", "", this, new java.lang.Object[] {  });
	}
